...
if __name__ == "__main__":
    start_dt = pd.Timestamp('2010-12-07 14:30:00', tz=pytz.UTC)
    end_dt = pd.Timestamp('2020-12-08 23:59:00', tz=pytz.UTC)
    ...
    data_source = CSVDailyBarDataSource(CSV_DATA_DIR, Equity, csv_symbols=strategy_symbols)
